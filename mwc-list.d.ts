...
declare const List_base: {
    new (): {
        mdcFoundation: import("@material/mwc-list/mwc-list-foundation").MDCListFoundation;
        mdcAdapter: import("@material/mwc-list/mwc-list-adapter").MDCListAdapter | null;
        readonly mdcFoundationClass: typeof import("@material/mwc-list/mwc-list-foundation").MDCListFoundation;
        ...
        itemsReadyResolver: (value?: never[] | PromiseLike<never[]> | undefined) => void;
        itemsReady: Promise<never[]>;
        _getUpdateComplete(): Promise<void>;
        readonly assignedElements: Element[];
        items_: import("@material/mwc-list/mwc-list-item-base").ListItemBase[];
        readonly items: import("@material/mwc-list/mwc-list-item-base").ListItemBase[];
        updateItems(): void;
        readonly selected: import("@material/mwc-list/mwc-list-item-base").ListItemBase | import("@material/mwc-list/mwc-list-item-base").ListItemBase[] | null;
        readonly index: import("@material/mwc-list/mwc-list-foundation").MWCListIndex;
        render(): import("lit-html").TemplateResult;
        renderPlaceholder(): import("lit-html").TemplateResult | null;
        firstUpdated(): void;
        onFocusIn(evt: FocusEvent): void;
        onFocusOut(evt: FocusEvent): void;
        onKeydown(evt: KeyboardEvent): void;
        onRequestSelected(evt: CustomEvent<import("@material/mwc-list/mwc-list-item-base").RequestSelectedDetail>): void;
        getIndexOfTarget(evt: Event): number;
        createAdapter(): import("@material/mwc-list/mwc-list-adapter").MDCListAdapter;
        selectUi(index: number, activate?: boolean | undefined): void;
        deselectUi(index: number): void;
        select(index: import("@material/mwc-list/mwc-list-foundation").MWCListIndex): void;
